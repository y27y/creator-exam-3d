...
<p align="center">
  <img src="./docs/images/ai-native-world-memory.png" alt="玩家意图被 AI 编译为棋盘造物，并成为居民、守夜与空域共同继承的世界记忆概念图" width="100%">
</p>

<p align="center"><em>AI 驱动效果概念图（GPT Image 2）：开放语言被编译为可执行造物，随后成为居民、守夜防线与裂隙空域共同继承的世界记忆。</em></p>
